...
class CameraCommandsDialogFragment1 : DialogFragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(
            R.layout.fragment_camera_commands1,
            container,
            false
        )
    ...
    private fun initViews(view: View?) {
        ...
        btnGetSnapshot = view?.findViewById(R.id.btnGetSnapshotEmail)
    ...
    override fun onClick(v: View?) {
        ...
        if (myCamera?.cameraModel.equals("MG-983G-30M") ||
            ...
            var command: String? = ""
            if (v?.id == R.id.btnGetSnapshotEmail) {
                command = "#T#E#"
                sendSMS(command)
    ...
    private fun showEmailsDialog() {
        ...
        if (this@CameraCommandsDialogFragment1.context != null) {
            val dialog = Dialog(this@CameraCommandsDialogFragment1.context!!)
