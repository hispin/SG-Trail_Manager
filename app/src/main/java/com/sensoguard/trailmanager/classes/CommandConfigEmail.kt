...
class CommandConfigEmail {
    ...
    fun populateCommands(): ArrayList<String> {
        commands.add("#s#$email#$password#$port#sphone#$server###0#")
        commands.add("#s#$email#$password#$port#internet.golantelecom.net.il#$server###0#")
        commands.add("#s#$email#$password#$port#uinternet#$server#orange#orange#0#")
        commands.add("#s#$email#$password#$port#sphone.pelephone.net.il#$server#pcl@3g#pcl#0#")
        commands.add("#s#$email#$password#$port#net.hotm#$server###0#")
        commands.add("#s#$email#$password#$port#netazi#$server###0#")
        commands.add("#s#$email#$password#$port#internet.rl#$server#rl@3g#rl#0#")
        commands.add("#s#$email#$password#$port#data.youphone.co.il#$server###0#")
        commands.add("#s#$email#$password#$port#uwap.orange.co.il#$server###0#")
        commands.add("#s#$email#$password#$port#we#$server###0#")
        return commands
    }
